            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com"
                    ...
                    <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#"
                            ...
                            <div class="profile"><img src="<?= site_url('recursos/') ?>img/avatar-3.jpg" alt="..."
                                                      class="img-fluid">
                            ...
                            <div class="profile"><img src="<?= site_url('recursos/') ?>img/avatar-2.jpg" alt="..."
                                                      class="img-fluid">
                            ...
                            <div class="profile"><img src="<?= site_url('recursos/') ?>img/avatar-1.jpg" alt="..."
                                                      class="img-fluid">
                            ...
                            <div class="profile"><img src="<?= site_url('recursos/') ?>img/avatar-5.jpg" alt="..."
                                                      class="img-fluid">
                ...
                <div class="list-inline-item dropdown">
                    <a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><img
                                src="<?= site_url('recursos/') ?>img/flags/16/GB.png" alt="English">
                        <span class="d-none d-sm-inline-block">English</span>
                    </a>
                    <div aria-labelledby="languages" class="dropdown-menu">
                        <a rel="nofollow" href="#" class="dropdown-item"> <img
                                    src="<?= site_url('recursos/') ?>img/flags/16/DE.png" alt="English"
                                    class="mr-2"><span>German</span></a><a rel="nofollow" href="#"
                                                                           class="dropdown-item"> <img
                                    src="<?= site_url('recursos/') ?>img/flags/16/FR.png" alt="English" class="mr-2">
                            <span>French  </span>
                        </a>
                    </div>
                </div>
...
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
            <div class="avatar"><img src="<?= site_url('recursos/') ?>img/avatar-6.jpg" alt="..."
