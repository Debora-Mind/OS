<div class="form-group">
    ...
    <input type="text" name="nome" placeholder="Insira o nome do grupo de acesso" class="form-control"
           value="<?= esc($grupo->nome) ?>">
</div>
<div class="form-group">
    <label class="form-control-label" for="descricao">Descrição</label>
    <textarea type="text" name="descricao" placeholder="Insira a descrição do grupo de acesso"
              class="form-control"><?= esc($grupo->descricao) ?></textarea>
</div>
<div class="custom-control custom-checkbox">
    <input type="hidden" name="tecnico" value="0">
    <input type="checkbox" class="custom-control-input" value="1" name="tecnico"
           id="tecnico" <?= $grupo->tecnico == true ? 'checked' : '' ?>>
